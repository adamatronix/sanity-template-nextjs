...
export function ArticlePreview(props: ComponentProps<UserViewComponent>) {
  const {
    document: {displayed},
    documentId,
    schemaType,
  ...
  return (
    <Suspense fallback={null}>
      <ArticlePreviewWithSecret id={id} slug={slug} type={type} />
    </Suspense>
  )
}

function ArticlePreviewWithSecret(props: {id: string; slug: string; type: string}) {
